    ...
    <div class="container-fluid">
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-1 col-md-offset-9 col-xs-2 text-center">
                    <div><a href="logic/authorization.php"><span class="hamburger"><img src="/images/ico/key-icon.png"> </span></a> </div>
                </div>
            </div>
            <div class="jumbotron">
                ...
                <p style="text-shadow: black 6px 9px 6px">Самые потрясающие события и яркие моменты
                    в наших объективах!</p>
            </div>
        </div>
    </div>
</header>
